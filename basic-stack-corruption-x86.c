...
void foo2(head *thing2) {
	...
	printf("Difference between addresses: %ld\n",
	       (unsigned long) the_pointer_to_smash - (unsigned long) &badpointer->field8);
	...
	printf("Address of badpointer->field11: %p\n", &badpointer->field11);
	printf("Difference between addresses: %ld\n",
	       (unsigned long) the_other_pointer_to_smash - (unsigned long) &badpointer->field11);

	badpointer->field11 = 37;
